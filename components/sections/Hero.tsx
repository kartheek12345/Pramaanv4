        ...
        <div className="hero-grid">
          ...
          <div>
            ...
            <p className="lead anim anim-d3" style={{ marginTop: "1.5rem" }}>
              Pramaan is not a marketplace. It's the verification layer that India's
              natural products industry has always lacked. We score products on what's provable
              — not what's printed on the label.
            </p>
